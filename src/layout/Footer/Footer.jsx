  ...
  return (
    <>
      <div className=" bg-gray-100">
        <div className="container flex py-3 px-24 mx-auto">
          <div className="w-100 mr-20">
            <h2 className="font-bold text-xl">Subcribe our Newsletter</h2>
          ...
          <div class="flex relative mt-5  mr-10">
            <div>
              <input
                className="  border text-sm tracking-wide pl-3 p-2  border-gray-400 rounded-3xl w-110"
                type="email"
            ...
            <div className="grid place-items-center">
              ...
              <div className="container">
                <div className=" flex mx-auto justify-between">
                  ...
                  <div>
                    <h5 className="text-white mx-4 font-bold">
                      {" "}
                      Download Mobile App{" "}
                    </h5>
              ...
              <div className="w-full text-gray-500 mb-4">
                <hr />
              </div>
            </div>
            <div
