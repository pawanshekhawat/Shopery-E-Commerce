      ...
      <div className="grid place-items-center">
        <div className="flex bg-amber-100 rounded-2xl p-4">
          ...
          <div className="p-8 text-center">
            <div>
              <h2 className="text-5xl font-bold ">Subcribe to our <br></br> Newsletter</h2>
            </div>

            <div >
              <p className="text-gray-400 text-center mt-5">
                
                Subscribe to our newlletter and Save your <span className="text-orange-500"> 20% <br></br> money</span> with
                discount code today.
              </p>
            </div>
