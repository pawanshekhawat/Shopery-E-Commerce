    ...
    <>
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="flex gap-6">
          ...
          <div className="w-80 bg-white rounded-lg shadow py-4">
            <h2 className="text-lg font-semibold mb-4 px-6">Neviation</h2>

            <ul className="space-y-2 text-gray-500">
              <li className=" items-center gap-3 py-2 rounded cursor-pointer">
                <div className="flex p-3 gap-2 hover:bg-green-50 hover:border-l-4 hover:border-green-500 ">
                  <svg
